...
def expr(args, seed):
    ...
    train_trajs_names = {}
    train_trajs_names['Walker2d-v3'] = './data/Walker2d-v3_sac_base_train_1000_trajs.pkl'
    train_trajs_names['Hopper-v3'] = './data/Hopper-v3_sac_base_train_1000_trajs.pkl'
    train_trajs_names['HalfCheetah-v3'] = './data/HalfCheetah-v3_sac_base_train_1000_trajs.pkl'
    train_trajs_names['Ant-v3'] = './data/Ant-v3_sac_base_train_1000_trajs.pkl'
    train_trajs_names['Humanoid-v3'] = './data/Humanoid-v3_sac_base_train_1000_trajs.pkl'
    ...
    eg.add('train_trajs_num', args.train_trajs_num)
...
def set_default_and_name(args):
    ...
    if args.train_trajs_num == None:
        args.train_trajs_num = -1
    else:
        name += '_ttn' + (str(args.train_trajs_num))
    
    if args.train_trajs_top_ratio == None:
        args.train_trajs_top_ratio = 0.5
    else:
        name += '_ttr' + (str(int(args.train_trajs_top_ratio*100)))
